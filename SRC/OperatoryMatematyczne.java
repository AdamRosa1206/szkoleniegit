...
public class OperatoryMatematyczne {
    ...
    public static void main(String[] args) {
        ...
        int mod = secondNumber%firstNumber; // ile razy 4 miesci sie w 6 tj 1 raz i zwraca resztę tj. 2
 ...
 /*       System.out.println("Wynik dodawania: " + addition); //+
        ...
        */
        ...
        firstNumber-=secondNumber; // firstNumber (zmienna nadpisana przez dzialanie powyzej) - secondNumber
        System.out.println("Po odejmowaniu " + firstNumber); //4
        firstNumber*=secondNumber; // firstNumber (znów nadpisana) * secondNumber
